                            ...
                            this.state.savedBooks.map((book, i) => {
                                return (
                                    <BookItemCard
                                        ...
                                        author={book.author}
                                        href={book.link}
                                        thumbnail={(book.thumbnail) ? (book.thumbnail) : ("http://4.bp.blogspot.com/-AxjRdX0V7aY/UJ6Fblgk2MI/AAAAAAAAI_w/bliXnEuBGHI/s200/Vintage+Gumball+Machine+Football+Helmets+-+Cardinals.JPG")}
